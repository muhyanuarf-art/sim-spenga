    ...
    <div class="card p-5">
        ...
        <?php else: ?>
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <a href="<?php echo e(route('mengajar.form', $j)); ?>"
                   class="border rounded-xl p-4 transition block <?php echo e(($j->sudah_diisi ?? false) ? 'border-emerald-200 bg-emerald-50/60' : 'border-slate-200 hover:border-brand-400 hover:bg-brand-50/40'); ?>">
                    <div class="flex items-center justify-between mb-1">
                        <p class="text-xs font-bold text-brand-600"><?php echo e($j->jamPelajaran->label); ?></p>
                        <?php if($j->sudah_diisi ?? false): ?>
