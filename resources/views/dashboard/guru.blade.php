    ...
    <div class="card p-5">
        ...
        @else
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <a href="{{ route('mengajar.form', $j) }}" class="border border-slate-200 rounded-xl p-4 hover:border-brand-400 hover:bg-brand-50/40 transition block">
                    <p class="text-xs font-bold text-brand-600 mb-1">{{ $j->jamPelajaran->label }}</p>
