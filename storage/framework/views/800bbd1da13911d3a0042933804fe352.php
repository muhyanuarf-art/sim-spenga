...
<body class="font-sans bg-gradient-to-br from-brand-900 via-brand-700 to-brand-600 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <p class="text-center text-brand-50/60 text-xs mt-6">© <?php echo e(date('Y')); ?> SIM-SPENGA · SMP Negeri 3 Bumiayu</p>
    </div>

</body>
</html>
<?php /**PATH C:\laragon\www\sim-spenga\resources\views/auth/login.blade.php ENDPATH**/ ?>