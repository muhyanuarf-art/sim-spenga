...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <x-stat-card color="sky" icon="fa-calendar-days" label="Jadwal Hari Ini" :value="$totalJadwalHariIni" suffix="jam" />
        <x-stat-card color="emerald" icon="fa-circle-check" label="Jurnal Terisi" :value="$totalJurnalHariIni" :suffix="'/ '.$totalJadwalHariIni" />
        <x-stat-card color="amber" icon="fa-chalkboard-user" label="Total Guru" :value="$totalGuru" />
        <x-stat-card color="violet" icon="fa-link" label="Mapping Aktif" :value="$totalMappingKelas" />
    </div>
    ...
    <div class="grid lg:grid-cols-3 gap-4">
        <a href="{{ route('kurikulum.guru-mengajar.index') }}" class="card p-5 hover:shadow-md hover:border-violet-200 transition group">
            <div class="w-10 h-10 rounded-xl bg-violet-500 text-white flex items-center justify-center text-lg mb-3 shadow-lg shadow-violet-500/30"><i class="fa-solid fa-chalkboard-user"></i></div>
        ...
        <a href="{{ route('jadwal.index') }}" class="card p-5 hover:shadow-md hover:border-sky-200 transition group">
            <div class="w-10 h-10 rounded-xl bg-sky-500 text-white flex items-center justify-center text-lg mb-3 shadow-lg shadow-sky-500/30"><i class="fa-solid fa-calendar-days"></i></div>
        ...
        <a href="{{ route('rekap.index') }}" class="card p-5 hover:shadow-md hover:border-emerald-200 transition group">
            <div class="w-10 h-10 rounded-xl bg-emerald-500 text-white flex items-center justify-center text-lg mb-3 shadow-lg shadow-emerald-500/30"><i class="fa-solid fa-chart-line"></i></div>
