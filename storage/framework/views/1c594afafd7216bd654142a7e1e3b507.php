...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - SIM-SPENGA</title>
...
<div class="min-h-screen flex">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1 text-base">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('dashboard') ? 'nav-active' : ''); ?>">
                <span class="text-lg">🏠</span> Dashboard
            </a>

            <?php if($user->role === 'guru' || $user->role === 'admin'): ?>
                <p class="nav-section">Guru Mapel</p>
                <a href="<?php echo e(route('mengajar.index')); ?>" class="nav-link <?php echo e(request()->routeIs('mengajar.*') ? 'nav-active' : ''); ?>">
                    <span class="text-lg">📝</span> Absensi & Jurnal Mengajar
                </a>
            <?php endif; ?>

            <?php if($user->role === 'admin' || $user->role === 'kurikulum' || $user->role === 'kepala_sekolah' || ($user->role === 'guru' && $user->isWaliKelas())): ?>
                <p class="nav-section">Wali Kelas</p>
                <a href="<?php echo e(route('walikelas.absensi-bulanan')); ?>" class="nav-link <?php echo e(request()->routeIs('walikelas.absensi-bulanan') ? 'nav-active' : ''); ?>">
                    <span class="text-lg">📊</span> Rekap Absensi Bulanan
                </a>
                <a href="<?php echo e(route('walikelas.jurnal-kelas')); ?>" class="nav-link <?php echo e(request()->routeIs('walikelas.jurnal-kelas') ? 'nav-active' : ''); ?>">
                    <span class="text-lg">📔</span> Jurnal Mengajar Kelas
                </a>
            <?php endif; ?>

            <?php if(in_array($user->role, ['guru', 'kurikulum', 'kepala_sekolah', 'admin'])): ?>
                <p class="nav-section">Laporan</p>
                <a href="<?php echo e(route('laporan.jurnal-guru')); ?>" class="nav-link <?php echo e(request()->routeIs('laporan.jurnal-guru') ? 'nav-active' : ''); ?>">
            ...
            <?php if($user->role === 'kurikulum' || $user->role === 'admin'): ?>
                ...
                <a href="<?php echo e(route('kelas.index')); ?>" class="nav-link <?php echo e(request()->routeIs('kelas.*') ? 'nav-active' : ''); ?>">
                    <span class="text-lg">🏫</span> Data Kelas
                </a>
                <a href="<?php echo e(route('mapel.index')); ?>" class="nav-link <?php echo e(request()->routeIs('mapel.*') ? 'nav-active' : ''); ?>">
                    <span class="text-lg">📚</span> Mata Pelajaran
                </a>
                <a href="<?php echo e(route('tahun-ajaran.index')); ?>" class="nav-link <?php echo e(request()->routeIs('tahun-ajaran.*') ? 'nav-active' : ''); ?>">
            ...
            <?php if($user->role === 'admin'): ?>
                ...
                <a href="<?php echo e(route('jam-pelajaran.index')); ?>" class="nav-link <?php echo e(request()->routeIs('jam-pelajaran.*') ? 'nav-active' : ''); ?>">
                    <span class="text-lg">⏰</span> Jam Pelajaran
                </a>
                <a href="<?php echo e(route('users.index')); ?>" class="nav-link <?php echo e(request()->routeIs('users.*') ? 'nav-active' : ''); ?>">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-20">
            <div class="flex items-center gap-3">
                ...
                <h1 class="font-semibold text-slate-800 text-base lg:text-lg"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
            </div>
            <div class="flex items-center gap-3">
                <div class="text-right hidden sm:block">
                    <p class="text-sm font-semibold text-slate-800 leading-tight"><?php echo e(auth()->user()->name); ?></p>
                    <p class="text-xs text-slate-400 leading-tight"><?php echo e(auth()->user()->roleLabel()); ?></p>
                </div>
...
<?php /**PATH C:\laragon\www\sim-spenga\resources\views/layouts/app.blade.php ENDPATH**/ ?>