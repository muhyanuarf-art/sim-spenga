...
<div class="space-y-6">
    ...
    {{-- 4 kartu ringkasan (Surat Masuk dihapus — tidak pernah ada alur
         yang membuat surat arah masuk di aplikasi ini). --}}
    ...
    <div class="grid lg:grid-cols-3 gap-4">
        ...
        <div class="card p-5 lg:col-span-2">
            ...
            @php
                $maxNilai = max(1, $statistik->flatMap(fn ($b) => [$b['keluar'], $b['disposisi_aktif']])->max());
        ...
        <div class="card p-5 lg:col-span-2">
            ...
            <div class="overflow-x-auto -mx-5">
                <table class="table-clean w-full">
                    <thead><tr><th>No. Surat</th><th>Siswa</th><th>Perihal</th><th>Tanggal</th><th>Status</th></tr></thead>
                    <tbody>
                    @forelse($suratTerbaru as $s)
                        ...
                        <tr class="cursor-pointer hover:bg-slate-50" onclick="location.href='{{ route('surat.show', $s) }}'">
                            ...
                            <td>
                                ...
                                @else
                                    <span class="px-2 py-0.5 rounded-full text-xs font-semibold bg-slate-100 text-slate-500 whitespace-nowrap">Tanpa Disposisi</span>
                                @endif
                            </td>
                        </tr>
                    @empty
                        <tr><td colspan="5" class="text-center text-slate-400 py-8">Belum ada surat.</td></tr>
                    @endforelse
                    </tbody>
                </table>
            </div>
